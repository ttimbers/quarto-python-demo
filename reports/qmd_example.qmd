...
The Python programming language (R Core Team, 2019) 
and the following Python packages were used to perform the analysis: pandas [@pandas], altair [@altair], click [@click], as well as Quarto [@Allaire_Quarto_2022]. 
...
![Horse populations for the province with the largest standard deviation.](../results/horse_pops_plot_largest_sd.png){#fig-horse_pop_plot_largest_sd width=60%}

In @fig-horse_pop_plot_largest_sd we zoom in and look at the province of `{python} largest_sd`, which had the largest spread of values in terms of standard deviation.
